...
struct AuraDamageStatics
{
	...
	AuraDamageStatics()
	{
		...
		TagsToCaptureDefs.Add(FAuraGameplayTags::Get().Attributes_Resistance_Physical, ArmorDef);
	}
};
	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for (const TTuple<FGameplayTag, FGameplayTag>& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		checkf(AuraDamageStatics().TagsToCaptureDefs.Contains(ResistanceTag), TEXT("TagsToCaptureDefs doesen't contain Tag: [%s] in ExecCalc_Damage"), *ResistanceTag.ToString());
	...
	// If CriticalHit, Double the damage and add CriticalHitDamage.
